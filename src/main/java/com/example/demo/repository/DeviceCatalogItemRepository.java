Repository  DeviceCatalogItemRepository.java package com.example.demo.repository;
...
EmployeeProfileRepository.java  package com.example.demo.repository;
...
PolicyRuleRepository.java  package com.example.demo.repository;
